"""
Django settings for alomacity project.
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 50,  # ✅ This is the default page size for pagination
}
...
WSGI_APPLICATION = 'alomacity.wsgi.application'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/1",  # DB 1 use
        "OPTIONS": {
